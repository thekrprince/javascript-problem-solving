...
const result = sum2zero([-3, -2, -1, 0, 1, 2, 3]);
console.log(result);
const result1 = sum2zero([-2, 0, 1, 3]);
console.log(result1);
const result2 = sum2zero([1, 2, 3]);
console.log(result2);
const result3 = sum2zero([1]);
console.log(result3);
const result4 = sum2zero([-3, -2, -1, 0, 2, 4, 6]);
console.log(result4);
