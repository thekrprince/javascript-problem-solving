 ...
 *
 * 1. In order to implement merge sort, it's useful to 1st implement a function responsible for merging two sorted arrays.
 * 2. Given 2 arrays which are sorted, this helper function should create a new array which is also sorted, and consists of all of the elements in the 2 input arrays.
 * 3. The function should run in O(n+m) time and O(n+m) space and should not modify the parameters passed to it.
 *
 * Pseudocode - Merge
